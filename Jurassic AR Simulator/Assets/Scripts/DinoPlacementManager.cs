...
public class DinoPlacementManager : MonoBehaviour
{
    public GameObject spawnableDinosaur;
    ...
    private void Update() {
        if(Input.touchCount > 0) 
        {
            if(Input.GetTouch(0).phase == TouchPhase.Began) 
            {
                ...
                {
                    GameObject _object = Instantiate(spawnableDinosaur);
    ...
    public void SwitchDinosaur(GameObject dinosaur)
    {
        spawnableDinosaur = dinosaur;
    }
}
